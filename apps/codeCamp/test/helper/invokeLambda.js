...
//TODO: When using this to test, do not write cards

invokeLambdaHelper.invoke = function (payload, returnResponse) {
    var call,
        params = {
    ...
    return call
        ...
        .then(function (data) {
            if (data.response && data.response.outputSpeech) {
                return returnResponse ? data : data.response.outputSpeech.ssml;
            }
