...
function getSessionsMatching(room) {
    return Cache.getSessionsMatching(room);
}

var sessionIntentFuncs = {
    handleSessionIntent: function (request, response) {
        var session = request.slot('Session'),
            endSession = true;
...
module.exports = sessionIntentFuncs;
